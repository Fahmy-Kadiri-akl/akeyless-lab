...
read -p "Enter your LAB ID (e.g., akeyless-lab-lastname): " LAB_ID

# Define variables
RESOURCE_GROUP="akeyless-lab"
...
read -p "VM deletion is complete. Do you want to continue with the installation? (yes/y/no/n): " response
